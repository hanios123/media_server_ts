...
export class Bot
{
	...
	_sctpSocket:any;
		...
		// @type {sctp.Stream}
	_sendStream  :any ;
	static async create({ mediasoupRouter }:{ mediasoupRouter :any })
	{
	...
	constructor({ udpSocket, sctpSocket, sendStream, transport, dataProducer }:{ udpSocket :any, sctpSocket  :any, sendStream :any, transport :any, dataProducer :any })
	{
	...
	async handleDataProducer({ dataProducerId, peer }:{ dataProducerId:any, peer:any })
	{
